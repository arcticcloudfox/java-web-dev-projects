...
public class Strings2 {
    public static void main(String[] args) {
        ...
        Integer index = alicePrompt.indexOf(search);
        Integer length = search.length();
        System.out.println("Your search term first appears at index " + index + ". Your term " +
                "is " + length + " characters long.");
        String modifiedSentence = alicePrompt.replace(search, "");
